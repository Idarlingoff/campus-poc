...
const VALID_FILTERS: FeedFilter[] = ['following', 'my_campus', 'all_campuses', 'public'];
...
export class FeedController {
    ...
    getFeed = async (req: Request, res: Response) => {
        ...
        const includeEvents = req.query.includeEvents ? String(req.query.includeEvents) !== 'false' : true;
