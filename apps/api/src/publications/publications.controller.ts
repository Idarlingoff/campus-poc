...
import { validateCreatePublication, validatePatchPublication } from './publications.validators';
...
export class PublicationsController {
    ...
    report = async (req: Request, res: Response) => {
        ...
        // Insert report
        const created = await this.service.report(req.params.id, reporterUserId, reason);
